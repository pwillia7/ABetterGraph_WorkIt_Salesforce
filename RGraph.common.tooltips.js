    ...
    */
    RGraph.Tooltip = function (obj, text, x, y, idx, e)
    {
        ...
        */
        ...
        tooltipObj.style.fontFamily      = 'Verdana, Geneva, sans-serif' 
        tooltipObj.style.fontSize        = RGraph.tooltips.font_size;
        tooltipObj.style.zIndex          = 3;
        tooltipObj.style.padding         = '17px 20px';
        tooltipObj.style.border          = '2px solid #FFF';
        tooltipObj.style.textAlign       = 'center';
